...
<div class="flex justify-center flex-col gap-5 items-center  w-screen h-screen">
    <p class="text-3xl text-center">Add Product</p>
    <form class="flex flex-col gap-[10px]" action="includs/add_product_formhandler.php" method="post">
        ...
        <button class="bg-black text-white py-3 hover:bg-opacity-80">Add</button>
    </form>
